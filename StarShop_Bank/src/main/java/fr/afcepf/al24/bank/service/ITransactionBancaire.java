...
public interface ITransactionBancaire {
	public boolean effectuerTransaction(@WebParam(name="numeroCarteDebit") Long numeroCarteDebit,@WebParam(name="dateFinValiditeDebit") Date dateFinValiditeDebit,@WebParam(name="cryptogrammeDebit") Integer cryptogrammeDebit,
