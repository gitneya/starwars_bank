...
insert client(client_datenaissance, client_nom,client_numero_identite,client_prenom) values ("1975-12-24","Dupond","1","Eric");
...
# Création d'un client
insert client(client_datenaissance, client_nom,client_numero_identite,client_prenom) values ("1970-09-01","Durand","2","Paul");
...
insert client(client_datenaissance, client_nom,client_numero_identite,client_prenom) values ("1985-12-24","Manufacture","3","Manufacture");
